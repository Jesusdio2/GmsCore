/*
 *     GPlayApi (adaptado para microG playapi)
...
package org.microg.vending.playapi

import org.microg.vending.playapi.data.models.AuthData
import org.microg.vending.playapi.data.providers.HeaderProvider.getAASTokenHeaders
import org.microg.vending.playapi.data.providers.HeaderProvider.getAuthHeaders
import org.microg.vending.playapi.data.providers.HeaderProvider.getDefaultHeaders
import org.microg.vending.playapi.data.providers.ParamProvider.getAuthParams
import org.microg.vending.playapi.data.providers.ParamProvider.getDefaultAuthParams
import org.microg.vending.playapi.exceptions.AuthException
import org.microg.vending.playapi.network.HttpClient
import org.microg.vending.playapi.utils.Util
...
class GooglePlayApi(private val authData: AuthData) {
    ...
    fun generateGsfId(): String {
        ...
        authData.deviceCheckInConsistencyToken =
            checkInResponse.deviceCheckinConsistencyToken
